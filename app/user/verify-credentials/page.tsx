    ...
    <div className="w-screen h-screen">
      <SidebarLayout>
        <section className="header md:my-10 my-5">
          <h3 className="text-2xl font-bold capitalize">Verification</h3>
          <Text className="py-1">Submit DID you want to verify instantly</Text>
        </section>
        ...
        <form className="w-full p-2 md:w-2/4 xl:w-2/4">
          ...
          <section className="my-4 mb-5">
            <label htmlFor="did" className="text-md block my-2">
              Enter DID
            </label>
            <Input type="password" name="did" placeholder="Enter your DID" />
          </section>
